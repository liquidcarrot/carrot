...
describe("Activation", () => {
    describe("activation.LOGISTIC()", () => {
        it("activation.LOGISTIC(number, derivative=false) => {number}", () => {
    ...
    describe("activation.TANH()", () => {
        it("activation.TANH(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
            expect(TanhActivation(x, false)).to.equal(Math.tanh(x));
        });
        it("activation.TANH(number, derivative=true) => {number}", () => {
            const x: number = randDouble(-50, 50);
            expect(TanhActivation(x, true)).to.equal(1 - Math.pow(Math.tanh(x), 2));
        });
    });
    describe("activation.IDENTITY()", () => {
        it("activation.IDENTITY(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.RELU()", () => {
        it("activation.RELU(number) => {number, derivative=false}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.SOFTSIGN()", () => {
        it("activation.SOFTSIGN(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.SINUSOID()", () => {
        it("activation.SINUSOID(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.GAUSSIAN()", () => {
        it("activation.GAUSSIAN(number) => {number, derivative=false}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.BENT_IDENTITY()", () => {
        it("activation.BENT_IDENTITY(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.BIPOLAR()", () => {
        it("activation.BIPOLAR(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.BIPOLAR_SIGMOID()", () => {
        it("activation.BIPOLAR_SIGMOID(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.HARD_TANH()", () => {
        it("activation.HARD_TANH(number) => {number, derivative=false}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.ABSOLUTE()", () => {
        it("activation.ABSOLUTE(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.INVERSE()", () => {
        it("activation.INVERSE(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
    ...
    describe("activation.SELU()", () => {
        ...
        it("activation.SELU(number, derivative=false) => {number}", () => {
            const x: number = randDouble(-50, 50);
