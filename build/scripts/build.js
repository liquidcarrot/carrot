...
var ParcelBundler = require("parcel-bundler");
...
function runBuild(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    entry = path.resolve(__dirname, '../build/scripts/index.js');
                    return [4 /*yield*/, new ParcelBundler(entry, options).bundle()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
