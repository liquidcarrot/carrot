...
describe("ArchitectTest", function () {
    it("Build Multilayer-Perceptron", function () {
        ...
        var numNodesWithRELU = network.nodes.filter(function (node) { return node.squash === src_1.RELU; }).length;
    ...
    it("Build Perceptron with pooling layer", function () {
        ...
        var numNodesWithIdentity = network.nodes.filter(function (node) { return node.squash === src_1.Identitiy; }).length;
    ...
    it("Build Multilayer-Perceptron with memory layer", function () {
        ...
        architect.addLayer(new InputLayer_1.InputLayer(10));
        architect.addLayer(new DenseLayer_1.DenseLayer(10, { activationType: src_1.RELU }));
        architect.addLayer(new MemoryLayer_1.MemoryLayer(outputSize, { memorySize: memorySize, activation: src_1.RELU }));
    ...
    it("Build Hopfield network", function () {
        ...
        chai_1.expect(network.gates.size).to.be.equal(0);
        var numNodesWithSTEP = network.nodes.filter(function (node) { return node.squash === src_1.BinaryStep; }).length;
