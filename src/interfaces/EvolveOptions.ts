...
export class EvolveOptions {
     ...
     */
    private _speciesDistanceThreshold: number = 4;
     ...
     */
    private _fitnessFunction?: (population: Network[], dataset?: {
        /**
         * The input values
         */
        input: number[],
     ...
     * Getter
     */
    public get fitnessFunction(): ((population: Network[], dataset?: {
        /**
         * The input values
         */
        input: number[],
     ...
     * Setter
     */
    public set fitnessFunction(value: ((population: Network[], dataset?: {
        /**
         * The input values
         */
        input: number[],
