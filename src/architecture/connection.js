...
//     if(Array.isArray(target[keys[index]]) && Array.isArray(source[keys[index]])) target[keys[index]] = target[keys[index]].concat(source[keys[index]]);
//     else if(isObject(target[keys[index]]) && isObject(source[keys[index]])) target[keys[index]] = merge(Object.assign({}, target[keys[index]]), source[keys[index]]);
//     else target[keys[index]] = source[keys[index]];
//   }
