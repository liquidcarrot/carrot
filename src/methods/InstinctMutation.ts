...
export const ALL_INSTINCT_MUTATIONS: Mutation[] = [
  new AddNodeMutation(),
  new SubNodeMutation(),
...
export const FEEDFORWARD_INSTINCT_MUTATIONS: Mutation[] = [
  new AddNodeMutation(),
  new SubNodeMutation(),
  new AddConnectionMutation(),
  new SubConnectionMutation(),
...
export const NO_STRUCTURE_INSTINCT_MUTATIONS: Mutation[] = [
  new ModWeightMutation(),
  new ModBiasMutation(),
  new ModActivationMutation(),
];
export const ONLY_STRUCTURE_INSTINCT_MUTATION: Mutation[] = [
  new AddNodeMutation(),
  new SubNodeMutation(),
  new AddConnectionMutation(),
  new SubConnectionMutation(),
