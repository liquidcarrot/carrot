...
export const MSELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
...
export const MBELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
...
export const BinaryLoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
...
export const MAELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
...
export const MAPELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
...
export const WAPELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
    error += Math.abs(targets[index] - value);
  });
...
export const MSLELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
...
export const HINGELoss: lossType = (targets: number[], outputs: number[]): number => {
  let error = 0;
  outputs.forEach((value, index) => {
