...
"use strict";var t=this&&this.__createBinding||(Object.create?function(t,e,o,n){void 0===n&&(n=o),Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[o]}})}:function(t,e,o,n){void 0===n&&(n=o),t[n]=e[o]}),e=this&&this.__setModuleDefault||(Object.create?function(t,e){Object.defineProperty(t,"default",{enumerable:!0,value:e})}:function(t,e){t.default=e}),o=this&&this.__importStar||function(o){if(o&&o.__esModule)return o;var n={};if(null!=o)for(var i in o)"default"!==i&&Object.hasOwnProperty.call(o,i)&&t(n,o,i);return e(n,o),n},n=this&&this.__awaiter||function(t,e,o,n){return new(o||(o=Promise))(function(i,r){function s(t){try{a(n.next(t))}catch(e){r(e)}}function u(t){try{a(n.throw(t))}catch(e){r(e)}}function a(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o(function(t){t(e)})).then(s,u)}a((n=n.apply(t,e||[])).next())})},i=this&&this.__generator||function(t,e){var o,n,i,r,s={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return r={next:u(0),throw:u(1),return:u(2)},"function"==typeof Symbol&&(r[Symbol.iterator]=function(){return this}),r;function u(r){return function(u){return function(r){if(o)throw new TypeError("Generator is already executing.");for(;s;)try{if(o=1,n&&(i=2&r[0]?n.return:r[0]?n.throw||((i=n.return)&&i.call(n),0):n.next)&&!(i=i.call(n,r[1])).done)return i;switch(n=0,i&&(r=[2&r[0],i.value]),r[0]){case 0:case 1:i=r;break;case 4:return s.label++,{value:r[1],done:!1};case 5:s.label++,n=r[1],r=[0];continue;case 7:r=s.ops.pop(),s.trys.pop();continue;default:if(!(i=(i=s.trys).length>0&&i[i.length-1])&&(6===r[0]||2===r[0])){s=0;continue}if(3===r[0]&&(!i||r[1]>i[0]&&r[1]<i[3])){s.label=r[1];break}if(6===r[0]&&s.label<i[1]){s.label=i[1],i=r;break}if(i&&s.label<i[2]){s.label=i[2],s.ops.push(r);break}i[2]&&s.ops.pop(),s.trys.pop();continue}r=e.call(t,s)}catch(u){r=[6,u],n=0}finally{o=i=0}if(5&r[0])throw r[1];return{value:r[0]?r[1]:void 0,done:!0}}([r,u])}}},r=this&&this.__spreadArrays||function(){for(var t=0,e=0,o=arguments.length;e<o;e++)t+=arguments[e].length;var n=Array(t),i=0;for(e=0;e<o;e++)for(var r=arguments[e],s=0,u=r.length;s<u;s++,i++)n[i]=r[s];return n};Object.defineProperty(exports,"__esModule",{value:!0}),exports.NEAT=void 0;var s=o(require("timsort")),u=require("./architecture/Species"),a=require("./methods/Mutation"),c=require("./utils/Utils"),p=function(){function t(t){if(!t.fitnessFunction)throw new ReferenceError("No fitness function given!");this._options=t,this.population=[],this.species=new Set;for(var e=0;e<this.options.populationSize;e++)this.population.push(this.options.template.copy())}return Object.defineProperty(t.prototype,"options",{get:function(){return this._options},set:function(t){this._options=t},enumerable:!1,configurable:!0}),t.prototype.mutateRandom=function(t){var e=this,o=this.options.mutations.filter(function(o){return o.constructor.name!==a.AddNodeMutation.constructor.name||t.nodes.length<e.options.maxNodes||o.constructor.name!==a.AddConnectionMutation.constructor.name||t.connections.size<e.options.maxConnections||o.constructor.name!==a.AddGateMutation.constructor.name||t.gates.size<e.options.maxGates});t.mutate(c.pickRandom(o),{allowedActivations:this.options.activations})},t.prototype.evolve=function(){return n(this,void 0,void 0,function(){var t,e,o;return i(this,function(n){switch(n.label){case 0:return this.genSpecies(),void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:n.sent(),this.sort(),n.label=2;case 2:return this.species.forEach(function(t){return t.evaluateScore()}),this.kill(1-this.options.survivors),this.removeExtinctSpecies(),this.reproduce(),t=this.population.splice(0,this.options.elitism),this.mutate(),(o=this.population).splice.apply(o,r([0,0],t)),[4,this.evaluate()];case 3:return n.sent(),this.sort(),(e=this.population[0].copy()).score=this.population[0].score,this.population.forEach(function(t){return t.score=void 0}),this.options.generation++,[2,e]}})})},t.prototype.mutate=function(t){var e=this;this.population.filter(function(){return Math.random()<=e.options.mutationRate}).forEach(function(o){for(var n=0;n<e.options.mutationAmount;n++)t?o.mutate(t):e.mutateRandom(o)})},t.prototype.evaluate=function(){var t,e;return n(this,void 0,void 0,function(){return i(this,function(o){switch(o.label){case 0:return this.options.clear&&this.population.forEach(function(t){return t.clear()}),[4,null===(e=(t=this.options).fitnessFunction)||void 0===e?void 0:e.call(t,this.population,this.options.dataset)];case 1:return o.sent(),this.sort(),[2,this.population[0]]}})})},t.prototype.sort=function(){s.sort(this.population,function(t,e){return void 0===t.score||void 0===e.score?0:e.score-t.score})},t.prototype.getFittest=function(){return n(this,void 0,void 0,function(){return i(this,function(t){switch(t.label){case 0:return void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:t.sent(),t.label=2;case 2:return this.sort(),[2,this.population[0]]}})})},t.prototype.getAverage=function(){return n(this,void 0,void 0,function(){var t;return i(this,function(e){switch(e.label){case 0:return void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:e.sent(),e.label=2;case 2:return t=0,this.population.map(function(t){return t.score}).forEach(function(e){return t+=null!=e?e:0}),[2,t/this.population.length]}})})},t.prototype.replacePopulation=function(t){this.population=t,this.options.populationSize=t.length},t.prototype.reproduce=function(){for(var t=Array.from(this.species),e=0;e<this.population.length;e++)if(null===this.population[e].species){var o=this.options.selection.select(t);this.population[e]=o.breed(),o.forcePut(this.population[e])}},t.prototype.removeExtinctSpecies=function(){for(var t=0,e=Array.from(this.species);t<e.length;t++){var o=e[t];o.size()<=1&&(o.members.forEach(function(t){return t.species=null}),this.species.delete(o))}},t.prototype.kill=function(t){this.species.forEach(function(e){return e.kill(t)})},t.prototype.genSpecies=function(){var t=this;this.species.forEach(function(t){return t.reset()}),this.population.filter(function(t){return null===t.species}).forEach(function(e){for(var o=!1,n=0,i=Array.from(t.species);n<i.length;n++){if(i[n].put(e,t.options.c1,t.options.c2,t.options.c3,t.options.speciesDistanceThreshold)){o=!0;break}}o||t.species.add(new u.Species(e))})},t}();exports.NEAT=p;
