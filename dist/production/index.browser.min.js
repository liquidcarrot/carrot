...
"use strict";function t(t){return i(t)||n(t)||e()}function e(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function n(t){if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))return Array.from(t)}function i(t){if(Array.isArray(t)){for(var e=0,n=new Array(t.length);e<t.length;e++)n[e]=t[e];return n}}function o(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function r(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function s(t,e,n){return e&&r(t.prototype,e),n&&r(t,n),t}var a=this&&this.__createBinding||(Object.create?function(t,e,n,i){void 0===i&&(i=n),Object.defineProperty(t,i,{enumerable:!0,get:function(){return e[n]}})}:function(t,e,n,i){void 0===i&&(i=n),t[i]=e[n]}),u=this&&this.__setModuleDefault||(Object.create?function(t,e){Object.defineProperty(t,"default",{enumerable:!0,value:e})}:function(t,e){t.default=e}),c=this&&this.__importStar||function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)"default"!==n&&Object.hasOwnProperty.call(t,n)&&a(e,t,n);return u(e,t),e},p=this&&this.__awaiter||function(t,e,n,i){return new(n||(n=Promise))(function(o,r){function s(t){try{u(i.next(t))}catch(e){r(e)}}function a(t){try{u(i.throw(t))}catch(e){r(e)}}function u(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n(function(t){t(e)})).then(s,a)}u((i=i.apply(t,e||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.NEAT=void 0;var l=c(require("timsort")),h=require("./architecture/Species"),f=require("./methods/Mutation"),v=require("./utils/Utils"),d=function(){function e(t){if(o(this,e),!t.fitnessFunction)throw new ReferenceError("No fitness function given!");this._options=t,this.population=[],this.species=new Set;for(var n=0;n<this.options.populationSize;n++)this.population.push(this.options.template.copy())}return s(e,[{key:"mutateRandom",value:function(t){var e=this,n=this.options.mutations.filter(function(n){return n.constructor.name!==f.AddNodeMutation.constructor.name||t.nodes.length<e.options.maxNodes||n.constructor.name!==f.AddConnectionMutation.constructor.name||t.connections.size<e.options.maxConnections||n.constructor.name!==f.AddGateMutation.constructor.name||t.gates.size<e.options.maxGates});t.mutate(v.pickRandom(n),{allowedActivations:this.options.activations})}},{key:"evolve",value:function(){return p(this,void 0,void 0,regeneratorRuntime.mark(function e(){var n,i,o,r,s,a,u,c,p,l,h,f,v;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return this.genSpecies(),e.next=3,this.evaluate();case 3:if(this.sort(),this.species.forEach(function(t){return t.evaluateScore()}),this.kill(1-this.options.survivors),this.removeExtinctSpecies(),this.reproduce(),i=this.population.splice(0,this.options.elitism),this.mutate(),(n=this.population).splice.apply(n,[0,0].concat(t(i))),!this.options.training){e.next=31;break}for(o=!0,r=!1,s=void 0,e.prev=15,a=this.population[Symbol.iterator]();!(o=(u=a.next()).done);o=!0)u.value.train(this.options.training);e.next=23;break;case 19:e.prev=19,e.t0=e.catch(15),r=!0,s=e.t0;case 23:e.prev=23,e.prev=24,o||null==a.return||a.return();case 26:if(e.prev=26,!r){e.next=29;break}throw s;case 29:return e.finish(26);case 30:return e.finish(23);case 31:return e.next=33,this.evaluate();case 33:for(this.sort(),(c=this.population[0].copy()).score=this.population[0].score,console.log("\n---------------------------"),console.log("Generation: "+this.options.generation+"; Species: "+this.species.size+"; Score: "+this.population[0].score),p=!0,l=!1,h=void 0,e.prev=41,f=this.species[Symbol.iterator]();!(p=(v=f.next()).done);p=!0)v.value.print();e.next=49;break;case 45:e.prev=45,e.t1=e.catch(41),l=!0,h=e.t1;case 49:e.prev=49,e.prev=50,p||null==f.return||f.return();case 52:if(e.prev=52,!l){e.next=55;break}throw h;case 55:return e.finish(52);case 56:return e.finish(49);case 57:return this.population.forEach(function(t){return t.score=void 0}),this.options.generation++,e.abrupt("return",c);case 60:case"end":return e.stop()}},e,this,[[15,19,23,31],[24,,26,30],[41,45,49,57],[50,,52,56]])}))}},{key:"mutate",value:function(t){var e=this;this.population.filter(function(){return Math.random()<=e.options.mutationRate}).forEach(function(n){for(var i=0;i<e.options.mutationAmount;i++)t?n.mutate(t):e.mutateRandom(n)})}},{key:"evaluate",value:function(){var t,e;return p(this,void 0,void 0,regeneratorRuntime.mark(function n(){return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return this.options.clear&&this.population.forEach(function(t){return t.clear()}),n.next=3,null===(e=(t=this.options).fitnessFunction)||void 0===e?void 0:e.call(t,this.population,this.options.dataset);case 3:return this.sort(),n.abrupt("return",this.population[0]);case 5:case"end":return n.stop()}},n,this)}))}},{key:"sort",value:function(){l.sort(this.population,function(t,e){return void 0===t.score||void 0===e.score?0:e.score-t.score})}},{key:"getFittest",value:function(){return p(this,void 0,void 0,regeneratorRuntime.mark(function t(){return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if(void 0!==this.population[this.population.length-1].score){t.next=3;break}return t.next=3,this.evaluate();case 3:return this.sort(),t.abrupt("return",this.population[0]);case 5:case"end":return t.stop()}},t,this)}))}},{key:"getAverage",value:function(){return p(this,void 0,void 0,regeneratorRuntime.mark(function t(){var e;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if(void 0!==this.population[this.population.length-1].score){t.next=3;break}return t.next=3,this.evaluate();case 3:return e=0,this.population.map(function(t){return t.score}).forEach(function(t){return e+=null!=t?t:0}),t.abrupt("return",e/this.population.length);case 6:case"end":return t.stop()}},t,this)}))}},{key:"replacePopulation",value:function(t){this.population=t,this.options.populationSize=t.length}},{key:"reproduce",value:function(){for(var t=Array.from(this.species),e=0;e<this.population.length;e++)if(null===this.population[e].species){var n=this.options.selection.select(t);this.population[e]=n.breed(),n.forcePut(this.population[e])}}},{key:"removeExtinctSpecies",value:function(){for(var t=0,e=Array.from(this.species);t<e.length;t++){var n=e[t];(n.size()<=1||n.stagnation>this.options.maxStagnation)&&(n.members.forEach(function(t){return t.species=null}),this.species.delete(n))}}},{key:"kill",value:function(t){this.species.forEach(function(e){return e.kill(t)})}},{key:"genSpecies",value:function(){var t=this;this.species.forEach(function(t){return t.reset()}),this.population.filter(function(t){return null===t.species}).forEach(function(e){for(var n=!1,i=0,o=Array.from(t.species);i<o.length;i++){if(o[i].put(e,t.options.c1,t.options.c2,t.options.c3,t.options.speciesDistanceThreshold)){n=!0;break}}n||t.species.add(new h.Species(e))})}},{key:"options",get:function(){return this._options},set:function(t){this._options=t}}]),e}();exports.NEAT=d;
