...
"use strict";var t=this&&this.__awaiter||function(t,e,i,n){return new(i||(i=Promise))(function(o,r){function s(t){try{u(n.next(t))}catch(e){r(e)}}function a(t){try{u(n.throw(t))}catch(e){r(e)}}function u(t){var e;t.done?o(t.value):(e=t.value,e instanceof i?e:new i(function(t){t(e)})).then(s,a)}u((n=n.apply(t,e||[])).next())})},e=this&&this.__generator||function(t,e){var i,n,o,r,s={label:0,sent:function(){if(1&o[0])throw o[1];return o[1]},trys:[],ops:[]};return r={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(r[Symbol.iterator]=function(){return this}),r;function a(r){return function(a){return function(r){if(i)throw new TypeError("Generator is already executing.");for(;s;)try{if(i=1,n&&(o=2&r[0]?n.return:r[0]?n.throw||((o=n.return)&&o.call(n),0):n.next)&&!(o=o.call(n,r[1])).done)return o;switch(n=0,o&&(r=[2&r[0],o.value]),r[0]){case 0:case 1:o=r;break;case 4:return s.label++,{value:r[1],done:!1};case 5:s.label++,n=r[1],r=[0];continue;case 7:r=s.ops.pop(),s.trys.pop();continue;default:if(!(o=(o=s.trys).length>0&&o[o.length-1])&&(6===r[0]||2===r[0])){s=0;continue}if(3===r[0]&&(!o||r[1]>o[0]&&r[1]<o[3])){s.label=r[1];break}if(6===r[0]&&s.label<o[1]){s.label=o[1],o=r;break}if(o&&s.label<o[2]){s.label=o[2],s.ops.push(r);break}o[2]&&s.ops.pop(),s.trys.pop();continue}r=e.call(t,s)}catch(a){r=[6,a],n=0}finally{i=o=0}if(5&r[0])throw r[1];return{value:r[0]?r[1]:void 0,done:!0}}([r,a])}}},i=this&&this.__spreadArrays||function(){for(var t=0,e=0,i=arguments.length;e<i;e++)t+=arguments[e].length;var n=Array(t),o=0;for(e=0;e<i;e++)for(var r=arguments[e],s=0,a=r.length;s<a;s++,o++)n[o]=r[s];return n};Object.defineProperty(exports,"__esModule",{value:!0}),exports.NEAT=void 0;var n=require("activations/build/src"),o=require("./architecture/Network"),r=require("./architecture/Species"),s=require("./methods/Mutation"),a=require("./methods/Selection"),u=require("./utils/Utils"),c=function(){function c(t){if(!t.fitnessFunction)throw new ReferenceError("No fitness function given!");this.dataset=t.dataset,t.dataset&&t.dataset.length>0?(this.input=t.dataset[0].input.length,this.output=t.dataset[0].output.length):(this.input=u.getOrDefault(t.input,0),this.output=u.getOrDefault(t.output,0)),this.generation=u.getOrDefault(t.generation,0),this.elitism=u.getOrDefault(t.elitism,1),this.equal=u.getOrDefault(t.equal,!0),this.clear=u.getOrDefault(t.clear,!1),this.populationSize=u.getOrDefault(t.populationSize,50),this.mutationRate=u.getOrDefault(t.mutationRate,.6),this.mutationAmount=u.getOrDefault(t.mutationAmount,5),this.fitnessFunction=t.fitnessFunction,this.selection=u.getOrDefault(t.selection,new a.FitnessProportionateSelection),this.mutations=u.getOrDefault(t.mutations,s.FEEDFORWARD_MUTATIONS),this.activations=u.getOrDefault(t.activations,Object.values(n.ALL_ACTIVATIONS)),this.template=u.getOrDefault(t.template,new o.Network(this.input,this.output)),this.maxNodes=u.getOrDefault(t.maxNodes,1/0),this.maxConnections=u.getOrDefault(t.maxConnections,1/0),this.maxGates=u.getOrDefault(t.maxGates,1/0),this.population=[],this.species=new Set;for(var e=0;e<this.populationSize;e++)this.population.push(this.template.copy())}return c.prototype.mutateRandom=function(t){var e=this,i=this.mutations.filter(function(i){return i.constructor.name!==s.AddNodeMutation.constructor.name||t.nodes.length<e.maxNodes||i.constructor.name!==s.AddConnectionMutation.constructor.name||t.connections.size<e.maxConnections||i.constructor.name!==s.AddGateMutation.constructor.name||t.gates.size<e.maxGates});t.mutate(u.pickRandom(i),{allowedActivations:this.activations})},c.prototype.evolve=function(){return t(this,void 0,void 0,function(){var t,n,o;return e(this,function(e){switch(e.label){case 0:return this.genSpecies(),void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:e.sent(),this.sort(),e.label=2;case 2:return this.species.forEach(function(t){return t.evaluateScore()}),this.kill(1-c.SURVIVORS),this.removeExtinctSpecies(),this.reproduce(),t=this.population.splice(0,this.elitism),this.mutate(),(o=this.population).splice.apply(o,i([0,0],t)),[4,this.evaluate()];case 3:return e.sent(),this.sort(),(n=this.population[0].copy()).score=this.population[0].score,this.population.forEach(function(t){return t.score=void 0}),this.generation++,[2,n]}})})},c.prototype.mutate=function(t){var e=this;this.population.filter(function(){return Math.random()<=e.mutationRate}).forEach(function(i){for(var n=0;n<e.mutationAmount;n++)t?i.mutate(t):e.mutateRandom(i)})},c.prototype.evaluate=function(){return t(this,void 0,void 0,function(){return e(this,function(t){switch(t.label){case 0:return this.clear&&this.population.forEach(function(t){return t.clear()}),[4,this.fitnessFunction(this.population,this.dataset)];case 1:return t.sent(),this.sort(),[2,this.population[0]]}})})},c.prototype.sort=function(){this.population.sort(function(t,e){return void 0===t.score||void 0===e.score?0:e.score-t.score})},c.prototype.getFittest=function(){return t(this,void 0,void 0,function(){return e(this,function(t){switch(t.label){case 0:return void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:t.sent(),t.label=2;case 2:return this.sort(),[2,this.population[0]]}})})},c.prototype.getAverage=function(){return t(this,void 0,void 0,function(){var t;return e(this,function(e){switch(e.label){case 0:return void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:e.sent(),e.label=2;case 2:return t=0,this.population.map(function(t){return t.score}).forEach(function(e){return t+=null!=e?e:0}),[2,t/this.population.length]}})})},c.prototype.replacePopulation=function(t){this.population=t,this.populationSize=t.length},c.prototype.reproduce=function(){for(var t=Array.from(this.species),e=0;e<this.population.length;e++)if(null===this.population[e].species){var i=this.selection.select(t);this.population[e]=i.breed(),i.forcePut(this.population[e])}},c.prototype.removeExtinctSpecies=function(){for(var t=0,e=Array.from(this.species);t<e.length;t++){var i=e[t];i.size()<=1&&(i.members.forEach(function(t){return t.species=null}),this.species.delete(i))}},c.prototype.kill=function(t){this.species.forEach(function(e){return e.kill(t)})},c.prototype.genSpecies=function(){var t=this;this.species.forEach(function(t){return t.reset()}),this.population.filter(function(t){return null===t.species}).forEach(function(e){for(var i=!1,n=0,o=Array.from(t.species);n<o.length;n++){if(o[n].put(e)){i=!0;break}}i||t.species.add(new r.Species(e))})},c.SPECIES_DISTANCE_THRESHOLD=3,c.C1=1,c.C2=1,c.C3=1,c.SURVIVORS=.8,c}();exports.NEAT=c;
