...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Species=void 0;var e=require("../NEAT"),r=require("../utils/Utils"),t=require("./Network"),s=function(){function s(e){this.representative=e,this.representative.species=this,this.members=new Set,this.members.add(e),this.score=0}return s.prototype.put=function(r){return r.distance(this.representative)<e.NEAT.SPECIES_DISTANCE_THRESHOLD&&(this.forcePut(r),!0)},s.prototype.forcePut=function(e){void 0!==e&&(this.members.add(e),e.species=this)},s.prototype.evaluateScore=function(){var e=0;this.members.forEach(function(r){var t;return e+=null!==(t=r.score)&&void 0!==t?t:0}),this.score=e/this.members.size},s.prototype.reset=function(){this.representative=r.pickRandom(this.members),this.members.forEach(function(e){return e.species=null}),this.members.clear(),this.members.add(this.representative),this.representative.species=this,this.score=0},s.prototype.kill=function(e){var r=Array.from(this.members);r.sort(function(e,r){return void 0===e.score||void 0===r.score?0:e.score-r.score});for(var t=Math.floor(e*this.members.size),s=0;s<t;s++)this.members.delete(r[s]),r[s].species=null},s.prototype.breed=function(){return t.Network.crossOver(r.pickRandom(this.members),r.pickRandom(this.members))},s.prototype.size=function(){return this.members.size},s.prototype.getBest=function(){var e=Array.from(this.members);return e[r.maxValueIndex(e.map(function(e){var r;return null!==(r=e.score)&&void 0!==r?r:-1/0}))]},s}();exports.Species=s;
...
"use strict";var t=this&&this.__awaiter||function(t,e,n,i){return new(n||(n=Promise))(function(o,r){function s(t){try{u(i.next(t))}catch(e){r(e)}}function a(t){try{u(i.throw(t))}catch(e){r(e)}}function u(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n(function(t){t(e)})).then(s,a)}u((i=i.apply(t,e||[])).next())})},e=this&&this.__generator||function(t,e){var n,i,o,r,s={label:0,sent:function(){if(1&o[0])throw o[1];return o[1]},trys:[],ops:[]};return r={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(r[Symbol.iterator]=function(){return this}),r;function a(r){return function(a){return function(r){if(n)throw new TypeError("Generator is already executing.");for(;s;)try{if(n=1,i&&(o=2&r[0]?i.return:r[0]?i.throw||((o=i.return)&&o.call(i),0):i.next)&&!(o=o.call(i,r[1])).done)return o;switch(i=0,o&&(r=[2&r[0],o.value]),r[0]){case 0:case 1:o=r;break;case 4:return s.label++,{value:r[1],done:!1};case 5:s.label++,i=r[1],r=[0];continue;case 7:r=s.ops.pop(),s.trys.pop();continue;default:if(!(o=(o=s.trys).length>0&&o[o.length-1])&&(6===r[0]||2===r[0])){s=0;continue}if(3===r[0]&&(!o||r[1]>o[0]&&r[1]<o[3])){s.label=r[1];break}if(6===r[0]&&s.label<o[1]){s.label=o[1],o=r;break}if(o&&s.label<o[2]){s.label=o[2],s.ops.push(r);break}o[2]&&s.ops.pop(),s.trys.pop();continue}r=e.call(t,s)}catch(a){r=[6,a],i=0}finally{n=o=0}if(5&r[0])throw r[1];return{value:r[0]?r[1]:void 0,done:!0}}([r,a])}}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.NEAT=void 0;var n=require("activations/build/src"),i=require("./architecture/Network"),o=require("./architecture/Species"),r=require("./methods/Mutation"),s=require("./methods/Selection"),a=require("./utils/Utils"),u=function(){function u(t){if(!t.fitnessFunction)throw new ReferenceError("No fitness function given!");this.dataset=t.dataset,t.dataset&&t.dataset.length>0?(this.input=t.dataset[0].input.length,this.output=t.dataset[0].output.length):(this.input=a.getOrDefault(t.input,0),this.output=a.getOrDefault(t.output,0)),this.generation=a.getOrDefault(t.generation,0),this.equal=a.getOrDefault(t.equal,!0),this.clear=a.getOrDefault(t.clear,!1),this.populationSize=a.getOrDefault(t.populationSize,50),this.mutationRate=a.getOrDefault(t.mutationRate,.6),this.mutationAmount=a.getOrDefault(t.mutationAmount,5),this.fitnessFunction=t.fitnessFunction,this.selection=a.getOrDefault(t.selection,new s.FitnessProportionateSelection),this.mutations=a.getOrDefault(t.mutations,r.FEEDFORWARD_MUTATIONS),this.activations=a.getOrDefault(t.activations,Object.values(n.ALL_ACTIVATIONS)),this.template=a.getOrDefault(t.template,new i.Network(this.input,this.output)),this.maxNodes=a.getOrDefault(t.maxNodes,1/0),this.maxConnections=a.getOrDefault(t.maxConnections,1/0),this.maxGates=a.getOrDefault(t.maxGates,1/0),this.population=[],this.species=new Set;for(var e=0;e<this.populationSize;e++)this.population.push(this.template.copy())}return u.prototype.mutateRandom=function(t){var e=this,n=this.mutations.filter(function(n){return n.constructor.name!==r.AddNodeMutation.constructor.name||t.nodes.length<e.maxNodes||n.constructor.name!==r.AddConnectionMutation.constructor.name||t.connections.size<e.maxConnections||n.constructor.name!==r.AddGateMutation.constructor.name||t.gates.size<e.maxGates});t.mutate(a.pickRandom(n),{allowedActivations:this.activations})},u.prototype.evolve=function(){return t(this,void 0,void 0,function(){var t;return e(this,function(e){switch(e.label){case 0:return this.genSpecies(),void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:e.sent(),e.label=2;case 2:return this.species.forEach(function(t){return t.evaluateScore()}),this.sort(),this.kill(1-u.SURVIVORS),this.removeExtinctSpecies(),this.reproduce(),this.mutate(),[4,this.evaluate()];case 3:return e.sent(),this.sort(),(t=this.population[0].copy()).score=this.population[0].score,this.population.forEach(function(t){return t.score=void 0}),this.generation++,[2,t]}})})},u.prototype.mutate=function(t){var e=this;this.population.filter(function(){return Math.random()<=e.mutationRate}).forEach(function(n){for(var i=0;i<e.mutationAmount;i++)t?n.mutate(t):e.mutateRandom(n)})},u.prototype.evaluate=function(){return t(this,void 0,void 0,function(){return e(this,function(t){switch(t.label){case 0:return this.clear&&this.population.forEach(function(t){return t.clear()}),[4,this.fitnessFunction(this.population,this.dataset)];case 1:return t.sent(),this.sort(),[2,this.population[0]]}})})},u.prototype.sort=function(){this.population.sort(function(t,e){return void 0===t.score||void 0===e.score?0:e.score-t.score})},u.prototype.getFittest=function(){return t(this,void 0,void 0,function(){return e(this,function(t){switch(t.label){case 0:return void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:t.sent(),t.label=2;case 2:return this.sort(),[2,this.population[0]]}})})},u.prototype.getAverage=function(){return t(this,void 0,void 0,function(){var t;return e(this,function(e){switch(e.label){case 0:return void 0!==this.population[this.population.length-1].score?[3,2]:[4,this.evaluate()];case 1:e.sent(),e.label=2;case 2:return t=0,this.population.map(function(t){return t.score}).forEach(function(e){return t+=null!=e?e:0}),[2,t/this.population.length]}})})},u.prototype.replacePopulation=function(t){this.population=t,this.populationSize=t.length},u.prototype.reproduce=function(){for(var t=Array.from(this.species),e=0;e<this.population.length;e++)if(null===this.population[e].species){var n=this.selection.select(t);this.population[e]=n.breed(),n.forcePut(this.population[e])}},u.prototype.removeExtinctSpecies=function(){for(var t=0,e=Array.from(this.species);t<e.length;t++){var n=e[t];n.size()<=1&&(n.members.forEach(function(t){return t.species=null}),this.species.delete(n))}},u.prototype.kill=function(t){this.species.forEach(function(e){return e.kill(t)})},u.prototype.genSpecies=function(){var t=this;this.species.forEach(function(t){return t.reset()}),this.population.filter(function(t){return null===t.species}).forEach(function(e){for(var n=!1,i=0,r=Array.from(t.species);i<r.length;i++){if(r[i].put(e)){n=!0;break}}n||t.species.add(new o.Species(e))})},u.SPECIES_DISTANCE_THRESHOLD=3,u.C1=1,u.C2=1,u.C3=1,u.SURVIVORS=.8,u}();exports.NEAT=u;
...
"use strict";var t=this&&this.__extends||function(){var t=function(e,i){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i])})(e,i)};return function(e,i){function o(){this.constructor=e}t(e,i),e.prototype=null===i?Object.create(i):(o.prototype=i.prototype,new o)}}();Object.defineProperty(exports,"__esModule",{value:!0}),exports.ActivationNode=void 0;var e=require("../../utils/Utils"),i=require("./ConstantNode"),o=function(i){function o(){return i.call(this)||this}return t(o,i),o.prototype.activate=function(){this.old=this.state;var t=Array.from(this.incoming).map(function(t){return t.from.activation*t.weight*t.gain});if(1!==t.length)throw new ReferenceError("Only 1 incoming connections is allowed!");return this.state=t[0],this.activation=this.squash(this.state,!1)*this.mask,this.derivativeState=this.squash(this.state,!0),this.activation},o.prototype.propagate=function(t,i){var o=this;i.momentum=e.getOrDefault(i.momentum,0),i.rate=e.getOrDefault(i.rate,.3),i.update=e.getOrDefault(i.update,!0);var r=Array.from(this.outgoing).map(function(t){return t.to.errorResponsibility*t.weight*t.gain});this.errorResponsibility=this.errorProjected=e.sum(r)*this.derivativeState,this.incoming.forEach(function(t){var e,r,n=o.errorProjected*t.eligibility;t.xTrace.forEach(function(t,e){n+=e.errorResponsibility*t}),t.deltaWeightsTotal+=(null!==(e=i.rate)&&void 0!==e?e:.3)*n*o.mask,i.update&&(t.deltaWeightsTotal+=(null!==(r=i.momentum)&&void 0!==r?r:0)*t.deltaWeightsPrevious,t.weight+=t.deltaWeightsTotal,t.deltaWeightsPrevious=t.deltaWeightsTotal,t.deltaWeightsTotal=0)})},o}(i.ConstantNode);exports.ActivationNode=o;
