      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            (_a = this.population).splice.apply(_a, __spreadArrays([0, 0], elitists)); // evaluate the population
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43307" + '/');
